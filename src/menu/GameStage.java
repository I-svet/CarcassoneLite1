...
//PopUp window;
    ...
    //    game.start(game);
     //   setPidName();
       // jButton1.setIcon(new ImageIcon(getClass().getResource("/images/PNGs/small/name/.png")));
      //  setButtonIcons();
    }
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(856, 642));

        jPanel1.setPreferredSize(new java.awt.Dimension(856, 642));

        jButton1.setText("yourCard");
        jButton1.setPreferredSize(new java.awt.Dimension(216, 216));

        jLabel1.setText("smth'sCard");
